...
def new_strategy_request(request_id):
    client_msg = ClientMsg()
    information_request = client_msg.information_requests.add()
    information_request.id = request_id
    information_request.algo_strategy_definition_request.algo_strategies.append('CQG ARRIVALPRICE')
...
if __name__ == "__main__":
    ...
    new_strategy_request(request_id)
    client.disconnect()
